...
class Client(models.Model):
    ...
    user=models.ForeignKey(User,on_delete=models.CASCADE,related_name='client_name',verbose_name=_("Agency Name"),null=True)
    
    class Meta:
        verbose_name = _('Manage Agency')
        verbose_name_plural = _('Manage Agencies')
    def __str__(self):
        return self.name
